...
RunConfiguration.setExecutionSettingFile('/var/folders/pp/rw_8q31s32v88_f01ndn6_b00000gn/T/Katalon/Test Cases/Create Event/20191204_072950/execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Create Event  Digital Services Georgia/Add Contact'))

not_run: WebUI.click(findTestObject('Page_Create Event  Digital Services Georgia/Contact'))

not_run: WebUI.click(findTestObject('Page_Create Event  Digital Services Georgia/Select Contact'))
