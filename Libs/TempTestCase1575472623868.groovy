...
RunConfiguration.setExecutionSettingFile('/var/folders/pp/rw_8q31s32v88_f01ndn6_b00000gn/T/Katalon/Test Cases/Create News/20191204_101703/execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Create News  Digital Services Georgia/span_- Select -'))

not_run: WebUI.click(findTestObject('Page_Create News  Digital Services Georgia/li_Blog'))
