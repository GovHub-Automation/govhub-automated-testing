...
<WebElementEntity>
   ...
   <name>div_Breadcrumb                             _179f3a</name>
   <tag></tag>
   <elementGuidId>5e56fd71-79b8-4b32-b3be-a38f47b9e35b</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>(.//*[normalize-space(text()) and normalize-space(.)='Digital Services Georgia'])[1]/following::div[1]</value>
      </entry>
   </selectorCollection>
  ...
  Rich Text Editor, To fieldEditor toolbarsFormatting BoldKeyboard shortcut Ctrl+B ItalicKeyboard shortcut Ctrl+ILinks LinkKeyboard shortcut Ctrl+K UnlinkMedia Link to DocumentUtilities CopyKeyboard shortcut Ctrl+C CutKeyboard shortcut Ctrl+X PasteKeyboard shortcut Ctrl+V Paste from Word Remove FormatOther Insert Special CharacterEnd Check AccessibilityAdmin-only SourcePress ALT 0 for helpElements pathbodyp 
...
About text formats
  ...
  Rich Text Editor, Re fieldEditor toolbarsFormatting BoldKeyboard shortcut Ctrl+B ItalicKeyboard shortcut Ctrl+ILinks LinkKeyboard shortcut Ctrl+K UnlinkMedia Link to DocumentUtilities CopyKeyboard shortcut Ctrl+C CutKeyboard shortcut Ctrl+X PasteKeyboard shortcut Ctrl+V Paste from Word Remove FormatOther Insert Special CharacterEnd Check AccessibilityAdmin-only SourcePress ALT 0 for helpElements pathbodyp 
...
About text formats
  ...
  Rich Text Editor, Summary fieldEditor toolbarsFormatting BoldKeyboard shortcut Ctrl+B ItalicKeyboard shortcut Ctrl+ILinks LinkKeyboard shortcut Ctrl+K UnlinkMedia Link to DocumentUtilities CopyKeyboard shortcut Ctrl+C CutKeyboard shortcut Ctrl+X PasteKeyboard shortcut Ctrl+V Paste from Word Remove FormatOther Insert Special CharacterEnd Check AccessibilityAdmin-only SourcePress ALT 0 for helpElements pathbodyp 
...
About text formats
  ...
  Rich Text Editor, Body fieldEditor toolbarsFormattingFormatNormal BoldKeyboard shortcut Ctrl+B ItalicKeyboard shortcut Ctrl+ILists + more Quotes Insert/Remove Bulleted List Insert/Remove Numbered List Decrease Indent Increase IndentLinks LinkKeyboard shortcut Ctrl+K Unlink Embed micro-content Embed contentMedia Embed media DocumentsUtilities CopyKeyboard shortcut Ctrl+C CutKeyboard shortcut Ctrl+X PasteKeyboard shortcut Ctrl+V Paste from Word Remove FormatOther Insert Special CharacterEnd Table Check Accessibility MaximizeAdmin-only SourcePress ALT 0 for helpElements pathbodyp 
...
No book selected.
    ...
    Format: 2019-12-12 16:39:55. Leave blank to use the time of form submission.
...
Schedule a status change
   ...
   <webElementProperties>
      ...
      <name>xpath</name>
      <type>Main</type>
      <value>/html[@class=&quot;no-touchevents details js&quot;]/body[@class=&quot;toolbar-tray-open toolbar-horizontal toolbar-fixed user-logged-in path-node&quot;]/div[@class=&quot;dialog-off-canvas-main-canvas&quot;]/div[@class=&quot;layout-container&quot;]</value>
   </webElementProperties>
   <webElementXpaths>
      <isSelected>true</isSelected>
      <matchCondition>equals</matchCondition>
   ...
   <webElementXpaths>
      ...
      <name>xpath:neighbor</name>
      <type>Main</type>
      <value>(.//*[normalize-space(text()) and normalize-space(.)='Subscription active (expires 2020/6/30)'])[1]/following::div[7]</value>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
