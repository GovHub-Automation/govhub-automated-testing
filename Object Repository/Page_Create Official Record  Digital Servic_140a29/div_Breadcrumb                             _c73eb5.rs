...
<WebElementEntity>
   ...
   <name>div_Breadcrumb                             _c73eb5</name>
   <tag></tag>
   <elementGuidId>3bef5f75-79ea-45b6-ba3f-b31dc92e29b7</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
  ...
  Create Official Record
      ...
      Short Title
        Content limited to 40 characters, remaining: 14
  ...
  Rich Text Editor, Summary fieldEditor toolbarsFormatting BoldKeyboard shortcut Command+B ItalicKeyboard shortcut Command+ILinks LinkKeyboard shortcut Command+K UnlinkMedia Link to DocumentUtilities CopyKeyboard shortcut Command+C CutKeyboard shortcut Command+X PasteKeyboard shortcut Command+V Paste from Word Remove FormatOther Insert Special CharacterEnd Check AccessibilityAdmin-only SourcePress ALT 0 for helpElements pathbodyp 
...
About text formats
      ...
      Record Type (required)
        - Select a value -LegislationRule
    ...
    Contact Information
              ...
              Test Keena contact Keena Hamilton
...
No book selected.
    ...
    Format: 2019-12-12 22:20:01. Leave blank to use the time of form submission.
